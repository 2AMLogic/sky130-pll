...
* tb_lf_c2_jitter_c2div9.sch -- this unit's C2-area/9 arm.
*
...
* (top_c2div9.sym instead of design/top/top.sym). Supply, 10 MHz reference,
...
S {}
E {}
C {sim/lf-c2-jitter-sensitivity/testbench/top_c2div9.sym} 0 0 0 0 {name=XXTOP}
