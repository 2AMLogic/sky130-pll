...
- **`analysis/`** is optional and, like `testbench/`, **mutable**: stdlib-only
  ...
  **two** campaigns' records: it restates this campaign's measured period jitter
  ...
  report this campaign's negative control `detected`, and commits six executed
  `klt yield` probes over deliberately **synthetic** populations so the
  ...
  evidence trail does not already carry.
