...
* top_c1div16.sch -- design/top/top.sch with its loop filter replaced by the
* DELIBERATELY DEGRADED loop_filter_c1div16.sym (C1 area / 16). NOT part of the
* design.
*
...
C {sim/lf-c1-jitter-sensitivity/testbench/loop_filter_c1div16.sym} 900 0 0 0 {name=XLF}
