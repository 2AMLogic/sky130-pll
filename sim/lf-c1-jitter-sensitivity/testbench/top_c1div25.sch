...
* top_c1div25.sch -- design/top/top.sch with its loop filter replaced by the
* DELIBERATELY DEGRADED loop_filter_c1div25.sym (C1 area / 25). NOT part of the
* design.
*
...
C {sim/lf-c1-jitter-sensitivity/testbench/loop_filter_c1div25.sym} 900 0 0 0 {name=XLF}
