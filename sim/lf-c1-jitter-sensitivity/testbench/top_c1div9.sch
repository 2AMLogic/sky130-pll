...
* top_c1div9.sch -- design/top/top.sch with its loop filter replaced by the
* DELIBERATELY DEGRADED loop_filter_c1div9.sym (C1 area / 9). NOT part of the
* design.
*
...
C {sim/lf-c1-jitter-sensitivity/testbench/loop_filter_c1div9.sym} 900 0 0 0 {name=XLF}
