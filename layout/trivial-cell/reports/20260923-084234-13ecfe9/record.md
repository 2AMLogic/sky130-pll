# Layout DRC/LVS record: 20260923-084234-13ecfe9
...
- **Spec row(s)**: none -- none. This is the trivial-cell proof of the `klt`-driven DRC/LVS flow (issue #2) -- a generated 2x2 mos_array plus its DRC/LVS negative controls, not PLL-block layout. It measures no spec/target-spec.md parameter and is deliberately uncited rather than mapped to a row it does not measure.
...
- Record ID: `20260923-084234-13ecfe9`
